...
"""Tests for object_detection.models.faster_rcnn_xception_feature_extractor."""

import numpy as np
import tensorflow as tf

from object_detection.models import faster_rcnn_xception_feature_extractor as faster_rcnn_xception


class FasterRcnnXceptionFeatureExtractorTest(tf.test.TestCase):

  def _build_feature_extractor(self,
                               first_stage_features_stride,
                               architecture='xception_71'):
    feature_extractor_map = {
        'xception_41':
            faster_rcnn_xception.FasterRCNNXception41FeatureExtractor,
        'xception_65':
            faster_rcnn_xception.FasterRCNNXception65FeatureExtractor,
        'xception_71':
            faster_rcnn_xception.FasterRCNNXception71FeatureExtractor
    }
  ...
  def test_extract_proposal_features_returns_expected_size(self):
    for architecture in ['xception_41', 'xception_65', 'xception_71']:
